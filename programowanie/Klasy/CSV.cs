...
namespace programowanie.Klasy
{
    ...
    class CSV : System.Windows.Forms.Form
    {
        ...
        /// </summary>
        /// <param name="plik_bazy">plik_bazy is a file with data.</param>
        public static bool findCSV2(string plik_bazy)
        {
            return File.Exists(plik_bazy) ? true : false;
        }//findCSV
        ...
        public static void search(System.Windows.Forms.DataGridView dataGridView1, string text)
        {
            if (dataGridView1.RowCount > 0)
            {
